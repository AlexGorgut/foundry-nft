...
import {DeployEuropeNft} from "../../script/DeployEuropeNft.s.sol";

contract DeployEuropeNftTest is Test {
    DeployEuropeNft public deployer;

    function setUp() public {
        deployer = new DeployEuropeNft();
    }
